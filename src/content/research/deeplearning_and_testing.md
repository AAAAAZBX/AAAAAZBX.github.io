...
## LEMON：库级覆盖引导的深度学习系统模糊测试[链接](/dl&test/LEMON.pdf)
...
## GraphFuzz：基于计算图的深度学习推理引擎模糊测试[链接](/dl&test/graphfuzz.pdf)
...
## FreeFuzz：利用开源数据的深度学习库API模糊测试[链接](/dl&test/freefuzz.pdf)
...
## EAGLE：生成等价计算图来测试深度学习库[链接](/dl&test/EAGLE.pdf)
...
## NeuRI：通过归纳规则推理实现DNN生成多样化[链接](/dl&test/NeuRI Diversifying DNN Generation via Inductive Rule Inference.pdf)
