---
title: "【置顶】 Technology 目录"
id: "2026-01-10"
date: "2026-01-10"
description: "【置顶】 Technology 目录 ， 包含数学，机器学习/深度学习/大语言模型，工具学习等模块"
tags: []
---
...
- [《随机过程》第一章-基础概念](https://aaaaazbx.github.io/learning/随机过程第一章/) (2026.1.10): 介绍事件与概率、随机变量和随机向量、随机过程的概念、数学期望、卷积、概率母函数、矩母函数等基础概念
- [《随机过程》第二章-马尔科夫链（Markov chain）](https://aaaaazbx.github.io/learning/随机过程第二章/) (2026.1.10): 介绍马尔科夫链的定义、转移概率、转移矩阵、多步转移概率、C-K方程、状态分类等
